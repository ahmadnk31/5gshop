...
export async function POST(req: NextRequest) {
  ...
  if (event.type === "payment_intent.succeeded") {
    ...
    const email = paymentIntent.receipt_email || paymentIntent.customer_email || paymentIntent.shipping?.name || "";
    ...
    const sendConfirmationEmail = (await import("@/lib/email/sendConfirmationEmail")).sendConfirmationEmail;
    if (email) {
